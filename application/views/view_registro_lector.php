                                ...
                                <fieldset>
									...
									<div class="form-line">
                                        ...
                                        <div class="help-info">debe ingresar 9 digitos</div>
																		...
																		<div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea  type="text" name="biog" class="form-control" id="biog" required><?php if (isset($_POST['biog'])) echo $_POST['biog'];?></textarea>
																						<label class="form-label col-sm-2" ><?php echo lang('vrr_biografia');?>:</label>
                                        </div>
                                    </div>
