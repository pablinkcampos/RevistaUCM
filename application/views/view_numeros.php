    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                ...
                <div class="body">
                    <a Download href="<?php echo base_url() . 'uploads/base.pdf' ?>" class="btn bg-blue waves-effect"><?php echo lang('vpl_descargar articulo');?></a><br>
                        <small><?php echo lang('vpl_documento que contiene las instrucciones');?>.</small>
                    </div>
                </div>
            </div>
            </center>
        ...
        <div class="postcontent nobottommargin col_last">
            <div id="posts" class="events small-thumbs">
              <?php
                function obtenerFechaEnLetra($fecha)
                {
                   ...
                   return $dia.', '.$num.lang('vnu_de').$mes.lang('vnu_del').$anno;
               }
               ...
               function conocerDiaSemanaFecha($fecha)
               {
                  ...
                  if ($filas->cantidad == 0)
                  {
                    echo '<div class="entry clearfix">
                              <div class="entry-title">
                                  <h2>'.lang("vnu_no tienes articulos").'</h2>
                              </div>
                ...
                if ($consulta)
                {
                    foreach ($consulta as $row) {
                          ...
                          echo '            <h2>'. $row->titulo_revista .' <i>('. obtenerFechaEnLetra($row->fecha_publicacion) .')'.' </h2>';
                          echo '        </div>';
                          echo '        <ul class="entry-meta clearfix">';
                          echo '            <li><i class="material-icons">event_available</i>'.lang("vnu_creada el").' '. obtenerFechaEnLetra($row->fecha_creacion) .'</li>';
                          echo '        </ul>';
                          ...
                          if ($row->logo_revista)
                          {
                            ...
                            echo'<div class="bookWrap">
                            		<div class="book">
                            			<a href="'.base_url().'index.php/Login/Index?revista=' . $row->ID . '" class="nobg"><img class="cover"
                          ...
                          echo '            <center>';
                          echo '            <div class="col-sm-offset-3 col-sm-6"><a href="'.base_url().'index.php/Login/Index?revista=' . $row->ID . '" class="button button-3d button-mini button-rounded button-blue btn-block">'.lang("vnu_ir a revista").'</a></div>';
                          echo '            <center>';
                ...
                {
                  echo '<center>';
                  echo '<h3>'.lang("vnu_pronto tendremos nuevas publicaciones").'</h3>';
                  echo '<center>';
                }
            ...
            <?php
              echo '<ul class="pager nomargin">';
                ...
                {
                  $next = $group_no + 1;
                  echo '<li class="next"><a href="'.base_url().'index.php/Home_principal/numeros?page=' . $next . '">'.lang("vnu_siguiente").' &rarr;</a></li>';
                }
                else if ($group_no + 1 == $cant_group && $group_no > 0)
                {
                  $back = $group_no - 1;
                  echo '<li class="previous"><a href="'.base_url().'index.php/Home_principal/numeros?page=' . $back . '">&larr; '.lang("vnu_anterior").'</a></li>';
                }
