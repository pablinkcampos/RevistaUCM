                ...
                <form name= "login-form" id="login-form" class="nobottommargin" action="<?php echo base_url(); ?>index.php/Login/recpass" method="post" onsubmit="return validate()">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                                ...
                                <input type="email" id="login-form-username" placeholder="Email" name="login-form-username" value="" required autofocus />
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <button class="btn btn-block bg-blue waves-effect" type="submit">Recuperar password</button>
                        </div>
                    </div>
