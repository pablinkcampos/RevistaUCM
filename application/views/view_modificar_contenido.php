    ...
    <div class="container clearfix">
        <div class="postcontent nobottommargin col_last">
            <div id="posts" class="events small-thumbs">
                ...
                <a href="<?php echo base_url(); ?>index.php/System/editor_cambia_mensaje_r" class="button button-3d button-rounded button-blue center"><?php echo lang('vmc_Mensaje recepcion de articulos');?></a>
                ...
                <a href="<?php echo base_url(); ?>index.php/System/editor_crud_temas" class="button button-3d button-rounded button-brown center">Editar Temas</a>
                <a href="<?php echo base_url(); ?>index.php/System/editor_cambia_mensaje_p" class="button button-3d button-rounded button-blue center"><?php echo lang('vmc_Mensaje publicacion efectiva');?></a>
                <a href="<?php echo base_url(); ?>index.php/System/editor_cambia_datos_r" class="button button-3d button-rounded button-red center"><?php echo lang('vmc_datos_revista');?></a>
            </div>
