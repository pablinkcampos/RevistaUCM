    ...
    <ul class="nav">
		...
		<li><a  class="button button-mini button-3d button-teal col_full" id="btn-1" data-toggle="collapse" data-target="#submenu1" aria-expanded="false"><?php echo lang('ME_articulos');?></a>
			<ul class="nav collapse" id="submenu1" role="menu" aria-labelledby="btn-1">
                ...
                <li><a class="button button-mini button-3d button-teal" href="#"><?php echo lang('ME_Rechazado por Editor');?></a></li>
                <li><a class="button button-mini button-3d button-teal" href="#"><?php echo lang('ME_Rechazado por Revisor');?></a></li>
                <li><a class="button button-mini button-3d button-teal" href="#"><?php echo lang('ME_Espera Version Final');?></a></li>
                <li><a class="button button-mini button-3d button-teal" href="#"><?php echo lang('ME_Aceptado Con Plazo Vencido');?></a></li>
			</ul>
		</li>
	</ul>
