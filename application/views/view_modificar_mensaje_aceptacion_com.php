        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card" style="min-width:600px;left:-30px;">
                <div class="header bg-blue">
                          ...
                          <h3>Mensaje aviso artículo aceptado con comentarios</h3>
                ...
                <form class="form-horizontal col-lg-3" action="<?php echo base_url(); ?>index.php/System/modifica_mensaje_aceptacion_com" method="POST" enctype="multipart/form-data">
