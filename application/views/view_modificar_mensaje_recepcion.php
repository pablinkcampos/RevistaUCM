    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card" style="min-width:600px;left:-30px;">
                ...
                <form class="form-horizontal col-lg-12 col-md-12 col-sm-12 col-xs-12" action="<?php echo base_url(); ?>index.php/System/modifica_mensaje_recepcion" method="POST" enctype="multipart/form-data">
