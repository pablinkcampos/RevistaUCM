                                    ...
                                    if($dife > $limite/2 ){
                                        ...
                                        echo "<td>"; echo $tema; echo "</td>";
                  					    echo "<td>"; echo $titulo_revista; echo "</td>";
                                              ...
                                              echo "<td>"; echo "<a href='".base_url()."index.php/articulo_editor/all_articulos_revisados_ver/".$id_revista."'><center><i class='material-icons' style='font-size:25px;'>zoom_in</i></center></center></a>"; echo "</td>";
