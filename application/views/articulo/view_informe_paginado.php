                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <h2 class="card-inside-title" style="margin:20px">Filtros</h2>
                            ...
                            <center>
                            <form name="form_art" class="form-horizontal" action="<?php echo base_url();?>index.php/Articulo_editor/informe_paginado_filtro" method="post"  enctype="multipart/form-data">
