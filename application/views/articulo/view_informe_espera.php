                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <h2>
                                Informe Artículos en espera versión final
                            </h2>
                        ...
                        <h2 class="card-inside-title" style="margin:20px">Filtros</h2>
                            ...
                            <center>
                            <form name="form_art" class="form-horizontal" action="<?php echo base_url();?>index.php/Articulo_editor/informe_espera_filtro" method="post"  enctype="multipart/form-data">
                                <div class="col-sm-4" style="margin:20px"> 
                                    <div class="form-group">
                                        <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4" >Fecha Inicial</label>
                                        <div class="form-line">
                                            <input type="text" class="datepicker form-control" value="<?php if (isset($_POST['f_ini'])) echo $_POST['f_ini']; ?>" name="f_ini" placeholder="fecha de inicio" required="requerid">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4" style="margin:20px" >
