...
class Info_revisor_model extends CI_Model {
    ...
    function lista_revisores_por_tema($tema)
    {
        ...
        $query = $this->db->query("SELECT rev.ID as ID, rev.email as email, CONCAT(rev.nombre,' ',rev.apellido_1,' ',rev.apellido_2) as nombre,rev.titulo_academico as titulo_academico , rev.fk_tema as tema, 
